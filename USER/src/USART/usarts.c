...
//    while (HAL_UART_Receive_IT(&huart6, (uint8_t *)g_rx_buffer, RXBUFFERSIZE) != HAL_OK)
//    {
//        timeout++;                              /* 超时处理 */
//        if (timeout > maxDelay)
//        {
...
//		HAL_UART_Transmit_DMA(&huart1, rx_buffer_f,rx_len);
//		HAL_UART_Transmit_DMA(&huart3, rx_imu_buff_s,140);
}
