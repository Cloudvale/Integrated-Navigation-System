...
enum nmeaGENTYPE
{
    ...
    NMEA_GEN_SAT_STATIC,    //静态
    NMEA_GEN_SAT_ROTATE,    //旋转
    NMEA_GEN_POS_RANDMOVE,  //随机移动
...
typedef int (*nmeaNMEA_GEN_INIT)(struct _nmeaGENERATOR *gen, nmeaINFO *info);  //参数为后面两个的int函数指针
