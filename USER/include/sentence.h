...
} nmeaGPGSV,nmeaGAGSV,nmeaGLGSV,nmeaGQGSV;
...
/**
 * KSXT  packet information structure 
 */
typedef struct _nmeaKSXT
{
		nmeaTIME utc; 			/**< UTC of position */
		double  lon;        /**< Longitude in NDEG - [degree][min].[sec/60] */
		double  lat;        /**< Latitude in NDEG - [degree][min].[sec/60] */
    double  Height;     /**<Height-海拔高度 */
		double Heading;     /**< */
		double pitch;
		double track_true;
		double Vel;
...
/**
 * GPHDT  packet information structure 
 */
 ...
 * KSXT  packet information structure 
 */
typedef struct _nmeaPSRDOPA
{
		char   utcs[10]; 			/**< UTC of position */
	  int    ones;
    double twos;
	  char   dssf[10];
		int 	 threes;
		...
		double  GDOP;        /**< Longitude in NDEG - [degree][min].[sec/60] */
		double  PDOP;        /**< Latitude in NDEG - [degree][min].[sec/60] */
	
    double  HDOP;     /**<Height-海拔高度 */
		double 	HTDOP;     /**< */
		double 	TDOP;
